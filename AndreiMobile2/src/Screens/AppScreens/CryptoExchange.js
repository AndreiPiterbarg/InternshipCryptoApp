...
import Icon from 'react-native-vector-icons/FontAwesome'; // Example: Using Font Awesome icons

const CryptoExchange = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.topBar}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('CryptoQuestion')} style={styles.questionButton}>
                    <Icon name="question-circle" size={24} color={questionColor} />
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.infoContainer}>
                ...
                <View style={styles.infoItem}>
                    ...
                    <Text style={styles.infoDescription}>
                        Established crypto exchanges must follow regulatory guidlines and requirements which help prevent fraudulent activity.
                ...
                <View style={styles.infoItem}>
                    ...
                    <Text style={styles.infoDescription}>
                        Some crypto exchanges provide insurance covers for users incase of hacks or security breaches.
